...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col select-none selection:bg-amber-200 selection:text-amber-900 relative overflow-hidden">
      ...
      <Link
        href="/"
        className="absolute top-6 left-6 z-20 flex items-center gap-2 text-stone-500 hover:text-stone-900 font-semibold text-sm transition-all duration-300 group bg-white/60 px-5 py-2.5 rounded-full shadow-sm border border-stone-200 hover:border-stone-300 hover:shadow-md sm:top-6 sm:left-6"
      >
      ...
      <Link
        href="/about"
        className="absolute top-6 left-6 mt-12 sm:mt-0 z-20 flex items-center gap-2 text-stone-500 hover:text-stone-900 font-semibold text-sm transition-all duration-300 group bg-white/60 px-5 py-2.5 rounded-full shadow-sm border border-stone-200 hover:border-stone-300 hover:shadow-md sm:top-6 sm:right-6"
      >
